...
public class UserLoginLogDO extends EntityObject<UserLoginLogDO, UserLoginLogDO.Key> {
    ...
    public static final class Table extends TableInfo<UserLoginLogDO, Key> {
        ...
        @Override
        public String getKeyUpdatePartialPrefixSql() {
            return "UPDATE `user_login_log` SET ";
        }

        @Override
        public String getKeyWhereByKeySql() {
            return " WHERE `id`=?";
        }

        @Override
        public String getKeyDeleteSql() {
            return "DELETE FROM `user_login_log` WHERE `id`=?";
        }

        @Override
        public Map<String, UniqueInfo> getUniques() {
            return uniqueMap;
        }
        ...
        @Override
        public String getFastInsertPrefixSql() {
            return "INSERT INTO `user_login_log` (`user_id`,`login_date`,`logout_date`,`longitude`,`latitude`,`ip`,`version`,`login_token`) VALUES ";
        }

        @Override
        public String getFastInsertValueItemsSql() {
            return " (?,?,?,?,?,?,?,?) ";
        }
        ...
        @Override
        public String getFormatSelectSql() {
            return "SELECT %s FROM `user_login_log` ORDER BY `id` DESC";
        }

        @Override
        public String getFormatSelectPrefixSql() {
            return "SELECT %s FROM `user_login_log` ";
        }

        @Override
        public String getSelectPrefixSql() {
            return "SELECT * FROM `user_login_log` ";
        }

        @Override
        public String getOrderByIdDescSql() {
        ...
        @Override
        public RowMapper<UserLoginLogDO> getRowMapper() {
        ...
        @Override
        public <C extends UserLoginLogDO> RowMapper<C> getRowMapper(final Class<C> cls) {
